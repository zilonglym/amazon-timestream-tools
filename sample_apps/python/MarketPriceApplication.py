...
from CrudAndSimpleIngestionMarketPrice import CrudAndSimpleIngestionMarketPrice
from CsvIngestionMarketPrice import CsvIngestionMarketPrice
...
if __name__ == '__main__':
    ...
    crud_and_simple_ingestion_example = CrudAndSimpleIngestionMarketPrice(write_client)
    csv_ingestion_example = CsvIngestionMarketPrice(write_client)
    ...
    # query_example.run_query_with_multiple_pages(5000)
