...
class CrudAndSimpleIngestionMarketPrice:
    ...
    def write_records(self):
        ...
        dimensions1 = [
            ...
            {'Name': 'ObjectId', 'Value': '0P00008Y8H'},
        ...
        price_set = [open_price, high_price, low_price, close_price]
        day1 = {
            'Dimensions': dimensions1,
            'MeasureName': 'marketPrice',
            'MeasureValueType': 'MULTI',
            'Time': current_time,
            'MeasureValues': price_set
        }
        day2 = {
        ...
        try:
            result = self.client.write_records(DatabaseName=Constant.DATABASE_NAME, TableName=Constant.TABLE_NAME,
                                               Records=[day1, day2], CommonAttributes={})
